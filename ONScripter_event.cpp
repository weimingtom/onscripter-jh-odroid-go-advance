...
Event type 0 (EV_SYN)
Event type 1 (EV_KEY)
UP, PE0, left up£ºtype 1 (EV_KEY), code 114 (KEY_VOLUMEDOWN), value 1->0
DOWN, PE7, left down£ºtype 1 (EV_KEY), code 115 (KEY_VOLUMEUP), value 1
LEFT: PE6, left left£ºtype 1 (EV_KEY), code 116 (KEY_POWER), value 1
RIGHT: PE4, left right£ºtype 1 (EV_KEY), code 117 (KEY_KPEQUAL), value 1
X, PE11, right up£ºtype 1 (EV_KEY), code 120 (KEY_SCALE), value 1
B, PE12, right down£ºtype 1 (EV_KEY), code 119 (KEY_PAUSE), value 1
Y, PE2, right left£ºtype 1 (EV_KEY), code 118 (KEY_KPPLUSMINUS), value 1
A, PE13, right right£ºtype 1 (EV_KEY), code 121 (KEY_KPCOMMA), value 1
SELECT, PE8, left 1£ºtype 1 (EV_KEY), code 122 (KEY_HANGUEL), value 1
START, PE9, left 2£ºtype 1 (EV_KEY), code 123 (KEY_HANJA), value 1
MENU, PE3, right 1£ºtype 1 (EV_KEY), code 124 (KEY_YEN), value 1
